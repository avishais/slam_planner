...
EIGEN1_DIR = /usr/include/eigen3

CXX= g++
CXXFLAGS= -I${OMPL_DIR}/include -I${OMPL_DIR}/lib/x86_64-linux-gnu -I$(EIGEN1_DIR) 
...
all:
	...
	#$(CXX) ${INC_RUN}test.cpp ${INC_VALIDITY}camera.cpp -o cam $(CXXFLAGS)  -std=c++11 #-Wall
